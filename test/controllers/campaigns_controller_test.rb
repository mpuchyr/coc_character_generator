...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference("Campaign.count") do
      post campaigns_url, params: { campaign: { character_id: @campaign.character_id, user_id: @campaign.user_id } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { character_id: @campaign.character_id, user_id: @campaign.user_id } }
